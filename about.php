<?php include 'includes/header.php'; ?>
    ...
    <div class="container-fluid page-header py-5 mb-5">
        <div class="container py-5">
            ...
            <p class="fs-5 fw-medium text-white">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Inventore temporibus at voluptatum quam iusto fuga atque, sint eaque animi ea deleniti assumenda veritatis deserunt minus esse! Vero eligendi sapiente blanditiis!</p>
    ...
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item">
                    <div class="overflow-hidden">
                        <a href="#"><img class="img-fluid" src="img/service-3.jpg" alt=""></a>
                    </div>
                    <div class="p-4 text-center border border-5 border-light border-top-0">
