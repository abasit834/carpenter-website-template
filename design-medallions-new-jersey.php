...
<div class="container-fluid page-header py-5 mb-5 position-relative" style="background: url('img/carousel-3.jpg') center center/cover no-repeat;">
    ...
    <div class="container py-5 position-relative">
        <h1 class="display-3 text-white mb-3 animated slideInDown">Custom Design Medallions</h1>
        ...
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item text-white active" aria-current="page">Custom Design Medallions</li>
            </ol>
        </nav>
    </div>
</div>
